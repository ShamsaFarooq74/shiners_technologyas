                ...
                <form action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row" class="border">
                        <div class="col-md-8 mx-auto py-4">
                            ...
                            <div class="form-group mb-3">
                                <label for=""class="mb-3">Enter Short Description</label>
                                <textarea type="" class="form-control"  rows="20" name="description"
                            ...
                            <div class="form-group mb-3">
                             ...
                             placeholder="Enter Service Description" >{{old('long_description')}}</textarea>
                          </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="py-5 mb-3">
                              <label for="">Select Tags </label>
                                <select class="tags-multiple-limit form-control" name="tags[]"
                                    multiple>
