                  ...
                  <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                      ...
                      <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" >
                        <a href="{{ route('projectPost.create') }}" class="btn btn-sm btn-light btn-active-primary" >
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                          ...
                          <thead>
                            <tr class="fw-bolder text-muted">
                              <th class="min-w-350px">Images</th>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="symbol symbol-150px me-5">
                                    ...
                                    <img src="{{ 'assets/uploads/posts/'.$image}}" alt=""/>
                                    @endforeach
                                  </div>
                                </div>
                              </td>
                              <td>
                                <p class="text-dark fw-bolder text-hover-primary d-block fs-6 ">{{substr(strip_tags(html_entity_decode($post->description)),0,8) }}</p>
                              </td>
                              <td>
                               <ul class="">
                            ...
                            @endforeach
                              ...
                              <td>
                                <ul class="">
                                 ...
                                 <li class="nav-item nav-link">
                                   {{-- {{$teamMember->projectTeamName->name}} --}}
                               </li>
                             @endforeach
                           </ul>
                               </td>
                               <td>
                                <ul class="">
                                 @foreach($projectComponents as $key=> $projectComponent)
                                 <li class="nav-item nav-link">
                                   {{-- {{$projectComponent->projectComponentName->title}} --}}
                               </li>
                             @endforeach
                           </ul>
                               </td>
                              ...
                              <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                  <form action="{{ route('projectPost.edit', $post->id) }}" method="post">
                                    @csrf
                                    @method('GET')
                                  ...
                                  <form action="{{ route('projectPost.destroy', $post->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                       <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
